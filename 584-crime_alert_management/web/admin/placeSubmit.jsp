            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form class="user" action="placeController.do" method="POST">
                            <div class="form-group">
                                <label for="crimeName">Place ID:</label>
                                <input type="text" class="form-control form-control-user" id="placeId" name="placeId" placeholder="Place Id">
                            </div>
                            <div class="form-group">
                                <label for="residentId">Place Name:</label>
                                <input type="text" class="form-control form-control-user" id="placename" name="placename" placeholder="Place Name">
                            </div>
